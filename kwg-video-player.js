...
(function (document, window) {
    ...
    function kwgVideo(selector, options) {
        var defaults = {
            ...
            fullscreenButtonHTML: '<svg width="19px" height="17px"><g data-id="full_screen_on" class="full_screen_on"><polygon data-id="bottom_left" points="6.78571429 14.4761905 2.71428571 14.4761905 2.71428571 10.8571429 0 10.8571429 0 16.8888889 6.78571429 16.8888889"></polygon><polygon data-id="top_left" points="2.71428571 2.41269841 6.78571429 2.41269841 6.78571429 0 0 0 0 6.03174603 2.71428571 6.03174603"></polygon><polygon data-id="bottom_right" points="19 10.8571429 16.2857143 10.8571429 16.2857143 14.4761905 12.2142857 14.4761905 12.2142857 16.8888889 19 16.8888889"></polygon><polygon data-id="top_right" points="16.2857143 2.41269841 16.2857143 6.03174603 19 6.03174603 19 0 12.2142857 0 12.2142857 2.41269841"></polygon></g><g id="full_screen_off" class="full_screen_off"><polygon id="bottom_left" points="0 13.2698413 4.07142857 13.2698413 4.07142857 16.8888889 6.78571429 16.8888889 6.78571429 10.8571429 0 10.8571429"></polygon><polygon id="top_left" points="4.07142857 3.61904762 0 3.61904762 0 6.03174603 6.78571429 6.03174603 6.78571429 0 4.07142857 0"></polygon><polygon id="bottom_right" points="12.2142857 16.8888889 14.9285714 16.8888889 14.9285714 13.2698413 19 13.2698413 19 10.8571429 12.2142857 10.8571429"></polygon><polygon id="top_right" points="14.9285714 3.61904762 14.9285714 0 12.2142857 0 12.2142857 6.03174603 19 6.03174603 19 3.61904762"></polygon></g></svg>',
    ...
    kwgVideo.prototype = {
        ...
        _registerEvents: function () {
            document.addEventListener("fullscreenchange", toggleFullscreenVideo);
            document.addEventListener("mozfullscreenchange", toggleFullscreenVideo);
            document.addEventListener("webkitfullscreenchange", toggleFullscreenVideo);
            document.addEventListener("msfullscreenchange", toggleFullscreenVideo);
        ...
        toggleMute: function () {
            if (this.el.muted) {
                ...
                this.el.muted = true;
                this.videoElements.volumePanel.classList.add('mute');
            }
            this.showVolume();
        },
        ...
        _playVideo: function () {
            ...
            this.videoElements.wrapperVideo.classList.add('play');
            this.showProgress();
        },
        ...
        toggleHoverVideo: function () {
            ...
            this.videoElements.wrapperVideo.classList.add('hover');
            this.showProgress();
        ...
        toggleSettingsMenu: function () {
            if (this.videoElements.settingsMenu.classList.contains('open')) {
                this.videoElements.settingsMenu.classList.remove('open');
            } else {
                this.videoElements.settingsMenu.classList.add('open');
            }
            this.closeSpeedMenu();
        },
        ...
        closeSpeedMenu: function () {
            if (this.videoElements.speedMenu.classList.contains('open')) {
                this.videoElements.speedMenu.classList.remove('open');
            }
        },
        changeSpeed: function (event) {
            ...
            if (!event.target.classList.contains('back')) {
                ...
                for (var i = 0; i < speedLislength; i++) {
                    if (speedLis[i].classList.contains('active')) {
                        speedLis[i].classList.remove('active');
                        break;
                    }
                }
        ...
        setSpeedLabel: function () {
            ...
            for (var i = 0; i < speedLislength; i++) {
                if (this.el.playbackRate == speedLis[i].getAttribute('data-speed')) {
                    ...
                    speedLis[i].classList.add('active');
                    break;
                }
            }
        },
    ...
    function toggleFullscreenVideo(e) {
